...
class ModelTraining:
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            ...
            logger.info("Starting our hyper param tuning")
            ...
            logger.error(f"error occured while training model {e}")
            raise CustomException("error ocurred while modelling data",e)
    ...
    def evaluate_model(self,model,X_test,y_test):
        try:
            ...
            logger.error(f"error occured while testing model {e}")
            raise CustomException("error ocurred while testing model",e)            
    ...
    def save_model(self,model):
        try:
            ...
            logger.info(f"Saved the model at {self.model_output_path}")

        except Exception as e:
            logger.error(f"error occured while saving model {e}")
            raise CustomException("error ocurred while saving model",e)
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("mdoel training successfully done")
        except Exception as e:
            logger.error(f"Error in the model trainig pipline {e}")
